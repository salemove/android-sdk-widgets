...
class RequestHandlerControllerTest {
    ...
    fun setUp() {
        ...
        controller = RequestHandlerController(
    ...
    fun `handleMediaUpgradeOfferAcceptResult will trigger OpenCallActivity state with Audio media type when offer is for Audio`() {
        ...
        state.assertNotComplete().assertValue(OneTimeEvent(RequestHandlerContract.State.OpenCallActivity(Engagement.MediaType.AUDIO)))
    ...
    fun `handleMediaUpgradeOfferAcceptResult will trigger OpenCallActivity state with Video media type when offer is for Video`() {
        ...
        confirmVerified(offer)
        state.assertNotComplete().assertValue(OneTimeEvent(RequestHandlerContract.State.OpenCallActivity(Engagement.MediaType.VIDEO)))
    ...
    fun `handleDialogCallback will produce RequestMediaUpgrade state when MediaUpgrade dialog state is triggered`() {
        ...
        state.assertNotComplete().assertValue(OneTimeEvent(RequestHandlerContract.State.RequestMediaUpgrade(data)))
    }
    ...
    fun `handleDialogCallback will produce DismissAlertDialog state when None dialog state is triggered`() {
        ...
        state.assertNotComplete().assertValue(OneTimeEvent(RequestHandlerContract.State.DismissAlertDialog))
    }
