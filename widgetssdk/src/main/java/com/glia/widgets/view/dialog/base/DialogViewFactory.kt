...
internal class DialogViewFactory(context: Context, unifiedTheme: UnifiedTheme?) {
    private val configuration: AlertDialogConfiguration = context.alertDialogConfiguration(unifiedTheme)
