...
internal class ScreenSharingController(
...
) : ScreenSharingContract.Controller {
    @VisibleForTesting
    val viewCallbacks: MutableSet<ScreenSharingContract.ViewCallback> = HashSet()
    ...
    override fun setViewCallback(screenSharingViewCallback: ScreenSharingContract.ViewCallback?) {
        screenSharingViewCallback?.run(viewCallbacks::add)
    }

    override fun removeViewCallback(screenSharingViewCallback: ScreenSharingContract.ViewCallback?) {
        viewCallbacks.remove(screenSharingViewCallback)
    }
