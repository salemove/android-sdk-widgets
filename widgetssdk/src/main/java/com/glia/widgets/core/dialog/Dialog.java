...
public final class Dialog {
    ...
    public static final int MODE_LIVE_OBSERVATION_OPT_IN = 14; //TODO: rename in a separate PR/commit
    public static final int MODE_ALREADY_IN_MESSAGING = 15;
    ...
    @IntDef({MODE_NONE, MODE_OVERLAY_PERMISSION, MODE_UNEXPECTED_ERROR, MODE_NO_MORE_OPERATORS, MODE_ENGAGEMENT_ENDED,
        ...
        MODE_MESSAGE_CENTER_UNAVAILABLE, MODE_UNAUTHENTICATED, MODE_LIVE_OBSERVATION_OPT_IN, MODE_ALREADY_IN_MESSAGING})
